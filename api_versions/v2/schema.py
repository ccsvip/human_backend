...
from api_versions.v2.models import Device, App, MediaFile, ModelItem
...
Media_Pydantic = pydantic_model_creator(MediaFile, name="Media")
Model_Pydantic = pydantic_model_creator(ModelItem, name="ModelItem")
...
class MediaOutSchema(Media_Pydantic):
    class Config:
        from_attributes = True

class MediaOutWithURLSchema(Media_Pydantic):
    url: str
    class Config:
        from_attributes = True
